...
log using "$logdir/labcovwave.log", replace
/*******************************************************************************
...
file open textfile using "$outputdir/labcovmaincox_wave`x'.csv", write replace
